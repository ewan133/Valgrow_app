...
class ItemDetails {
  ...
  factory ItemDetails.fromDocument(DocumentSnapshot doc) {
    ...
    return ItemDetails(
      ...
      last_updated: (data['last_updated'] as Timestamp?)?.toDate() ??
          DateTime.now(), // ✅ Convert Firestore Timestamp
    );
  }
  ...
  ItemDetails copyWith({
    ...
    return ItemDetails(
      ...
      unpaid_price: unpaid_price ?? this.unpaid_price,
      category: category ?? this.category,
      unit: unit ?? this.unit,
      barcode: barcode ?? this.barcode,
      item_image: item_image ?? this.item_image,
      storeId: storeId ?? this.storeId,
      total_stock: total_stock ?? this.total_stock,
